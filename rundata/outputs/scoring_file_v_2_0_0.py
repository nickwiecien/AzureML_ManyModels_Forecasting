...
data_sample = PandasParameterType(pd.DataFrame({"WeekStarting": pd.Series(["2000-1-1"], dtype="datetime64[ns]"), "Advert": pd.Series([0], dtype="int64"), "Brand": pd.Series(["example_value"], dtype="object"), "Price": pd.Series([0.0], dtype="float64"), "Revenue": pd.Series([0.0], dtype="float64"), "Store": pd.Series([0], dtype="int64")}), enforce_shape=False)
